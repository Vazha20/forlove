...
export default function LovePage() {
  ...
  const photos = [
    ...
    { src: "mcxeta.jpeg", caption: "ეს მცხეთაა უბრალოდ იმას ვცდილობ რომ მხოლოდ ნინი არ იყოს ჩემით გახარებული ყველა მის ირგვლივ,თან თიკო იყო გასასეირნებელი თორე ამათ იმედად მარტო კლინიკაში ყავდათ 😄" }, 
