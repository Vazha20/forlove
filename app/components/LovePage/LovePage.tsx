...
export default function LovePage() {
  ...
  const photos = [
    ...
    { src: "", caption: "18.01.2026 პირველად ურთიერთობაში რომ მე ნინისგან რამე მეწყინა თან მძიმედ მეწყინა ჩემში ვიღაცამ ეჭვი გაუჩინა მაგრამ არ დაიჯერა არ დაიჯერაზე მეტად უფრო ის იყო რომ მაინც შიგნიდან აწუხებდა ეს ფაქტი..." }, 
