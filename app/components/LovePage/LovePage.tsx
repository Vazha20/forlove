...
export default function LovePage() {
  ...
  const photos = [
    ...
    { src: "keria.jpeg", caption: "დღე, როდესაც ოფიციალურად სახლში შევუვარდი და ნახა რომ ცოტა ვერ ვარ 😄 თამუნას და ნუკის გაცნობის დღე 😄 დღე კი ცუდად დაიწყო მაგრამ როგორც შეგვეფერებოდა ისე დავასრულეთ 🥰" },
    { src: "firstdate.png", caption: "დღე, როცა დრო გაჩერდა ⏳ 05.11.2025 პირველი შეხვედრა" },
    { src: "firstdate.png", caption: "დღე, როცა დრო გაჩერდა ⏳ 05.11.2025 პირველი შეხვედრა" }, 
  ];
