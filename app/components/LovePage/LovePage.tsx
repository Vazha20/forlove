...
export default function LovePage() {
  ...
  const photos = [
    ...
    { src: "axaliweli.jpeg", caption: "01.01.2026 თარიღი როდესაც ცხოვრებაში პირველად ოჯახის წევრების გარეშე შევხვდი ახალ წელს.თან წინა დღეებში გავაბრაზე მეგონა რომ მხოლოდ ქვემოთ ჩამოსვლით შემოიფარგლებოდა მაგრამ არა გამიმართლა და ერთად შევხვდით ამ დღეს ყველაზე ბედნიერი წლის დასაწყისი იყო ჩემთვის 🥰 თან თიკოც გავიცანი.მოკლედ იდეალურადაა ყველაფერი იმის კვალობაზე რომ ჯერ ორი თვეც არაა გასული...🥰ამ დღეს მგონი ყველას გახარება შევძელი..." }, 
    { src: "", caption: "მერე იყო 2 , 3 , 5 , 6 , 7 შობასაც ერთად შევხვდით სანთელიც ავანთეთ რაღაცეები ჩავიფიქრეთ მე ნინი ჩავიფიქრე თვითონ არვიცი...🥰" }, 
